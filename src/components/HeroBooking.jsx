...
const CAR_IMG = "https://i.ibb.co.com/jPyZS1qS/ff2dbc0d6e519913771b5450b6304c22.jpg"
    ...
    <section className="bg-[#fbfbf8] dark:bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 py-14 md:py-20 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          >
            Book cars in seconds. Transparent pricing, flexible scheduling,
            and modern fleet ready for any trip.
          </motion.p>
          ...
          >
            <a href="#book" className="px-5 py-3 rounded-lg font-semibold text-white bg-orange-600 hover:bg-orange-700 transition">
              Book a Car
            </a>
            <a href="/vehicles" className="px-5 py-3 rounded-lg font-semibold border border-slate-300 text-slate-700 bg-white hover:bg-slate-50 transition">
              Learn More
            </a>
          </motion.div>
        </div>

        {/* Right: spring parallax car + spec card */}
        <div ref={wrapRef} onMouseMove={onMouseMove} onMouseLeave={onLeave} className="relative">
          <animated.img
            src={CAR_IMG}
            alt="Car"
            style={{
